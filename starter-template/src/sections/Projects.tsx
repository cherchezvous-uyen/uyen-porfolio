          ...
          <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              <div className="lg:pb-16">
                ...
                <ul className="flex flex-col mt-4 md:mt-4 ">
                  {project.results.map(result=> (
                    <li className="flex gap-2 mt-4 text-sm md:text-base text-white/50">
                ...
                <a href={project.link}>
                  <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-8 rounded-xl 
